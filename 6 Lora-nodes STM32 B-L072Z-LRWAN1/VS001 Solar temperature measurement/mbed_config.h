...
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x01, 0x74, 0x5F }                                                 // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x4C, 0x04, 0x1D, 0xCE, 0x08, 0x19, 0x6F, 0xBA, 0x2E, 0xB4, 0x00, 0xFC, 0x8E, 0xA1, 0xDB, 0xF5 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x00, 0xA6, 0x91, 0x4D, 0x33, 0x2C, 0x74, 0x84 }                                                 // set by application[*]
