...
#define CLOCK_SOURCE                                                          USE_PLL_HSI                                                                                      // set by target:MCU_STM32G0
#define HSE_VALUE                                                             8000000                                                                                          // set by target:NUCLEO_G071RB
#define LPTICKER_DELAY_TICKS                                                  0                                                                                                // set by target:MCU_STM32G0
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:MCU_STM32G0
