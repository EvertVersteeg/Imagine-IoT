...
Application/Startup/startup_stm32h723zgtx.o: ../Application/Startup/startup_stm32h723zgtx.s Application/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m7 -c -I../../Inc -x assembler-with-cpp -MMD -MP -MF"Application/Startup/startup_stm32h723zgtx.d" -MT"$@" --specs=nano.specs -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
